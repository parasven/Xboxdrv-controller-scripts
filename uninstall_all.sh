...
rm -v /usr/local/bin/8Bitdo_M30_GamePad_Xboxdrv.sh
rm -v /usr/local/bin/Xbox_360_Wireless_Receiver_Xboxdrv.sh
rm -v /usr/local/bin/Playstation_Dualshock_3_Controller_Xboxdrv.sh

## Remove all Symlinks we created in /etc/udev/rules.d/
rm -v /etc/udev/rules.d/99-input-8Bitdo_SFC30_GamePad_Xboxdrv.rules
rm -v /etc/udev/rules.d/99-input-8Bitdo_M30_GamePad_Xboxdrv.rules
...
rm -v /etc/udev/rules.d/99-input-Playstation_Dualshock_3_Controller_Xboxdrv.rules
...
rm -v /etc/systemd/system/8Bitdo_M30_GamePad_Xboxdrv@.service
...
rm -v /etc/systemd/system/Playstation_Dualshock_3_Controller_Xboxdrv@.service
